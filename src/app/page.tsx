    ...
    return (
        <>
            <div className="min-h-screen bg-[#f4faff] text-[#333333] font-sans ">
                ...
                <SectionTitle id="tools" text="Tools"/>
                <section className="max-w-5xl mx-auto mt-8 px-6 grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
                    <div
                ...
                <SectionTitle id="contribute" text="Contribute"/>
                <section
